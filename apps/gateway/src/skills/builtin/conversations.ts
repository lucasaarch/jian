...
\`send_session_message\` writes into another of your conversations. In a WhatsApp or Telegram
chat or group, the person receives it on that channel, as a message from you. Any other
conversation receives it in its inbox, which \`read_inbox\` reads.
